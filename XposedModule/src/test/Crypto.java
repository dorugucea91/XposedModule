...
//				XposedBridge.log("after");
				...
				findAndHookMethod("java.net.Socket", lpparam.classLoader, "getOutputStream", new XC_MethodReplacement() {
					@Override
				...
				findAndHookMethod("java.net.Socket", lpparam.classLoader, "getInputStream", new XC_MethodReplacement() {
					@Override
					protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
						/* debugging */
